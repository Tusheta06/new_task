...
window.NayePankhData = (() => {
  ...
  // Official Newspaper Recognition Data (from real NGO recognition!)
  const newspaperRecognition = [
    {
      id: 'news1',
      title: 'The Pioneer',
      excerpt: 'NayePankh Foundation distributes free sanitary napkins and sanitizers in rural sectors, spreading crucial menstrual hygiene awareness among underprivileged women.',
      date: 'October 12, 2021',
      badge: 'Menstrual Hygiene Campaign'
    },
    {
      id: 'news2',
      title: 'Dainik Jagran',
      excerpt: 'Youth-led student organization NayePankh serves over 50,000 warm nutritional meals to daily wagers and slum families affected by seasonal winter lockouts.',
      date: 'January 28, 2022',
      badge: 'Hunger Relief Drive'
    },
    {
      id: 'news3',
      title: 'Hindustan',
      excerpt: 'President Prashant Shukla and NayePankh volunteers recognized by city officials for organizing vaccination and feeding camps for stray street animals in Kanpur.',
      date: 'June 05, 2022',
      badge: 'Stray Animal Welfare'
    }
  ];

  // Legal Registration Certificates Data
  const legalRegistry = [
    {
      id: 'reg-society',
      title: 'Society Registration',
      authority: 'UP Government Registry',
      badge: 'Act 1860 Compliant',
      desc: 'NayePankh Foundation is officially registered under the Societies Registration Act, 1860. Registration ID: <strong>KAP/04397/2021-2022</strong>.'
    },
    {
      id: 'reg-80g',
      title: '80G Tax Exemption',
      authority: 'Income Tax Department',
      badge: '50% Tax Deduction',
      desc: 'Holds active 80G tax benefit certification. URN: <strong>AAGAN9381EF20227</strong>. Donors save up to 50% of their contributions from taxable income.'
    },
    {
      id: 'reg-12a',
      title: '12A Registration',
      authority: 'Income Tax Department',
      badge: 'Non-Profit Status',
      desc: 'Registered under Section 12A of the Income Tax Act, 1961, establishing the organization’s status as a transparent, verified non-profit trust.'
    }
  ];
  ...
  // Preset chatbot responses based on keywords (extended with official website parameters!)
  const qaDatabase = [
    {
    ...
    {
      keywords: ['nayepankh', 'what is nayepankh', 'ngo info', 'about foundation', 'society'],
      answer: "NayePankh Foundation is a registered UP Government Section 8 NGO (Society Reg: **KAP/04397/2021-2022**). Our motto is **'Badalte Bharat Ki Nayi Tasveer'**. We work in core sectors: feeding the hungry, underprivileged child education, women sanitation pads distribution, and stray animal care."
    },
    {
      keywords: ['tax exemption', '80g', 'tax benefit', 'receipt', 'urn'],
      answer: "Yes! All contributions to NayePankh Foundation are eligible for tax exemption under **Section 80G** of the Income Tax Act. URN: **AAGAN9381EF20227**. Donors receive an instant receipt and certificate saving up to 50% of taxable outflow."
    },
    {
    ...
    {
      keywords: ['contact', 'phone', 'mobile', 'email', 'number', 'address', 'office'],
      answer: "You can reach NayePankh Foundation through the following official channels:\n\n- **Email**: contact@nayepankh.com\n- **Phone**: +91-8318500748\n- **Head Office**: Kanpur, Uttar Pradesh, India\n- **Operations**: Kanpur, Ghaziabad, and various other cities in UP."
    },
    {
      keywords: ['founder', 'president', 'prashant', 'shukla'],
      answer: "NayePankh Foundation was founded by **Prashant Shukla**, who serves as the Founder and President. Under his leadership, the organization has expanded to support over 200,000 underprivileged lives in India."
    }
  ];
